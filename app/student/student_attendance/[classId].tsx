...
const StudentAttendance = () => {
  ...
  useEffect(() => {
    const unsubscribe = NetInfo.addEventListener((state) => {
      setCurrentIp(
        state.type === "wifi" && "ipAddress" in (state.details ?? {})
  ...
  const handleBarCodeScanned = async ({
    ...
    try {
      ...
      if (params.classId != classId) {
        ...
        Alert.alert(
          "❌ Điểm danh thất bại",
          `Bạn không phải sinh viên lớp này, vui lòng hãy quét đúng mã QR`,
          [
            {
              text: "Quét lại",
              onPress: () => scanAgain(),
        ...
        <View style={styles.errorContainer}>
          <Surface style={styles.errorCard}>
            ...
            <Paragraph style={styles.errorText}>
              Vui lòng cấp quyền truy cập camera trong cài đặt để sử dụng tính
              năng điểm danh QR.
            </Paragraph>
            <Button
              mode="contained"
          ...
          <View style={styles.resultContainer}>
            <Card style={styles.failureCard}>
              <Card.Content style={styles.resultContent}>
                ...
                <Title style={styles.failureTitle}>
                  Điểm danh thất bại! ❌
                </Title>
                <Paragraph style={styles.resultText}>
                ...
                <Surface style={styles.infoCard}>
                  ...
                  <View style={styles.infoRow}>
                    <Text style={styles.infoLabel}>Thời gian:</Text>
                    <Text style={styles.infoValue}>{getVietnamTime()}</Text>
                  </View>
                  <View style={styles.infoRow}>
                    <Text style={styles.infoLabel}>IP hiện tại:</Text>
                    <Text style={styles.infoValue}>
